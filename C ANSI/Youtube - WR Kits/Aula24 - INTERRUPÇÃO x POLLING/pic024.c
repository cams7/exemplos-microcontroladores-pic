...
void interrupt() {                   //Vetor de interrupção , endereço 04h de memória
   if(T0IF_bit) {                    //Houve o estouro do TIMER0?
       ...
       if(counter == 500) {          //1/(4MHz/4) * (prescaler 1:256 TMR0) * (2^8 - TMR0) * counter = 1us * 4 * 250 * 500 = 500ms
          RB4_bit = ~RB4_bit;
          counter = 0;
       }
...
bit 2-0 PS<2:0>: Prescaler Rate Select bits
        ...
        111        1 : 256    1 : 128
*/
   OPTION_REG = 0x81;                //0b1000 0001 - Desabilita os resistores de pull-up internos
