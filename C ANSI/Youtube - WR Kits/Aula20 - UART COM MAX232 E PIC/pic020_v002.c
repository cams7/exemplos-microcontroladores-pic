...
*/
   ADCON0 = 0x00;             // 0b00000000 - Desabilita os conversores AD
/**
Página 128
...
*/
   ADCON1 = 0x06;             // 0b00000110 - Tornar todo ADC digital
  
   TRISB = 0xF8;              // 0b11111000 - RB7 como entrada digital
   ...
   while (1) {                     // Endless loop
      ...
      if(butt) {
         UART1_Write_Text("Alert!"); // Escreve o texto Start
         UART1_Write(LF);            // Realimentação de linha
         UART1_Write(CR);          // Quebra de linha
      }
  }
