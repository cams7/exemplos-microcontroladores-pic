...
; --- Registradores de Uso Geral ---
 ...
 cont1											; Registrador auxiliar
 cont2											; Registrador auxiliar
...
main:
				...
				rlf			PORTB				; Rotaciona um bit à direita
...
delay2:
				...
				decfsz		cont2				; Decrementa o valor do 2º contador até que seja igual a zero
				goto		delay2				; Vai para a label 'delay2' 

												; (249 x 10 - 1) + 8 = 2497 ciclos de máquina

				decfsz		cont1				; Decrementa o valor do 1º contador até que seja igual a zero
