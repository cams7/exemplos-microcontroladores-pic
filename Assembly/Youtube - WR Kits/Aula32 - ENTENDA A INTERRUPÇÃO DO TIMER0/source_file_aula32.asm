;
; Curso de Assembly para PIC WR Kits Aula 32
;
;
...
; --- Registradores de Uso Geral ---
	...
	cont1									;Registrador para armazenar o conteúdo do contador
	endc									;Final da memória do usuário
	

; --- Vetor de RESET ---
	org			H'0000'						;Origem no endereço 00h de memória
	goto		main						;Desvia para a label início
...
; -- Final do Salvamento de Contexto --
	...
	call		inicializa_timer0			;Chama a subrotina 'inicializa_timer0'
	
	decfsz		cont1,F						;Decrementa 'cont1' e pula se for igual a zero. O conteúdo de 'cont1' é igual a zero?
	goto		exit_ISR					;Não, desvia para saída da interrupção 

	call		inicializa_contador			;Chama a subrotina 'inicializa_contador'
...
inicializa_timer0:
	...
	movwf		TMR0						;Inicializa TMR0 em 00h. Timer0 = 256 - 0 = 256
	return									;Retorna

inicializa_contador:
	movlw		D'16'						;Move a literal 15d para work
	movwf		cont1						;Inicializa cont1 com 15d
	return									;Retorna	
