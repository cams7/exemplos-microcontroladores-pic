...
inicio:
				...
				movwf		TRISB				;TRISB = H'F5' configura RB0 e RB1 como saída
...
delay500ms:
				...
				movwf		tempo1				;Inicializa a variável tempo0
												;Gasta 4 ciclos de máquina

aux1:
				movlw		D'249'				;Move o valor para W
				movwf		tempo2				;Inicializa a variável tempo1
				nop
				nop
				nop
				nop
...
aux2:
				...
				decfsz		tempo2				;Decrementa tempo1 até que seja igual a zero
				goto		aux2				;Vai para a label aux2 

												;(249 x 10 - 1) + 8 = 2497 ciclos de máquina

				decfsz		tempo1				;Decrementa tempo0 até que seja igual a zero
				goto		aux1				;Vai para a label aux1
												...
												;d = 10ab + 10b + 5
												;d = (10a + 10)b + 5
												;delay = (10 x tempo1 + 10) x tempo2 + 5
